...
files = c(
  "balanced_bins/Galaxy1-[hESC_TotbalMatrix_hg19_40kb].data",
  "balanced_bins/Galaxy3-[10A_TotbalMatrix_hg19_40kb].data",
  "balanced_bins/Galaxy5-[AT1_TotBalMatrix_hg19_40kb].data",
  "balanced_bins/Galaxy2-[CA1a_TotBalMatrix_hg19_40kb].data",
  "balanced_bins/Galaxy4-[MCF7_TotbalMatrix_hg19_40kb].data"
)
# files = files[c(2,5)]
files = files[c(1,3:4)]
