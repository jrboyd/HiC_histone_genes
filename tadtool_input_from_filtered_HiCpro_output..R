...
convert_HiCPro_OUT_to_Tadtool_IN = function(hicp_matrix_file, hicp_bed_file, cell, binSize, chr, start, end, out_dir = "~/R/HiC_histone_genes/tads_input"){
  ...
  M = new("dgTMatrix",
          ...
          x= as.double(target_matrix_dt$V3), 
  ...
  M[,93:95] = 0
  M[93:95,] = 0
  my_write.table(as.matrix(M), file = paste0(paste(prefix, chr, start, end, sep = "_"), "_matrix.filtered.txt"))
  setwd(start_dir)
  return(M)
}
#pooled samples
...
setwd("~/HiC-Pro/outputs/MCF10A_pooled/hic_results/matrix/MCF10A_20split")
system.time({M = convert_HiCPro_OUT_to_Tadtool_IN(hicp_matrix_file = "iced/40000/MCF10A_20split_40000_iced.matrix", 
                                     hicp_bed_file = "raw/40000/MCF10A_20split_40000_abs.bed",
                                     cell = "MCF10A_pooled",
                                     binSize = 40000, 
                                     chr = "chr1", start = 1, end = 248956422 )})
setwd("~/R/test_HBP/")
system.time({M = convert_HiCPro_OUT_to_Tadtool_IN(hicp_matrix_file = "tiny_test.matrix", 
                                                  hicp_bed_file = "tiny_test.bed",
                                                  cell = "tiny_test",
                                                  binSize = 40000, 
                                                  chr = "chr1", start = 1, end = 120000 )})
